...
public struct Polygon: Hashable {
  ...
  public init(_ point1: (Double, Double),
              _ point2: (Double, Double),
              _ point3: (Double, Double),
              _ points: (Double, Double)...) {
    let point1 = Point(latitude: point1.0,
                       longitude: point1.1)
    let point2 = Point(latitude: point2.0,
                       longitude: point2.1)
    let point3 = Point(latitude: point3.0,
                       longitude: point3.1)
