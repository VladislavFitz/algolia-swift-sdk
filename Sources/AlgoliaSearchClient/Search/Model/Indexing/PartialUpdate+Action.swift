...
extension PartialUpdate.Action {
  enum Storage: Codable, Equatable {
    case set(JSON)
    case operation(PartialUpdateOperation)

    public init(from decoder: Decoder) throws {
      if let operation = try? PartialUpdateOperation(from: decoder) {
...
extension PartialUpdate.Action {
  init(operation: PartialUpdateOperation.Kind, value: JSON) {
...
public extension PartialUpdate.Action {
  ...
  /// Increment a numeric attribute
  /// - Parameter value: Value to increment by
  static func increment(attribute _: Attribute, value: Double) -> Self {
    .init(operation: .increment, value: .init(value))
  }
}
...
public extension PartialUpdate.Action {
  ...
  /// - Parameter value: Value to remove
  static func remove(attribute _: Attribute, value: Int) -> Self {
    .init(operation: .remove, value: .init(value))
  }
