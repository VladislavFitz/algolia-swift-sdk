...
public final class HierarchicalFacetController {
  ...
  public func select(_ hierachicalFacetValue: String) {
    
    let computedSelections = selections(from: hierachicalFacetValue)
  ...
  private func selections(from hierachicalFacetValue: String) -> [String] {
